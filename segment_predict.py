...
def segment_and_predict(image_path="mask_capture.png"):
    ...
    for contour in contours:
        ...
        # Map predicted class to labels (0-9, +, -, *, /, A-Z)
        predicted_class = np.argmax(prediction, axis=-1)
        predictions.append(predicted_class[0])
        # if predicted_class[0] < 10:
        #     # Digit (0-9)
        #     predictions.append(predicted_class[0])
        # elif predicted_class[0] < 14:
        #     # Operator (+, -, *, /)
        #     operator_symbols = ['+', '-', '*', '/']
        #     operator_index = predicted_class[0] - 10
        #     predictions.append(operator_symbols[operator_index])
        # else:
        #     # Uppercase letters (A-Z)
        #     letter_index = predicted_class[0] - 14 + ord('A')
        #     predictions.append(letter_index)

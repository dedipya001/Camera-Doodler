...
@st.cache(suppress_st_warning=True, hash_funcs={st.delta_generator.DeltaGenerator: lambda _: None})
def open_camera(camera_view_placeholder):
    ...
    tools_path="newtools.png"
    tools = cv2.imread("newtools.png")
    ...
    while True:
        ...
        cv2.putText(frm, curr_tool, (270 + margin_left, 30), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0), 1)
